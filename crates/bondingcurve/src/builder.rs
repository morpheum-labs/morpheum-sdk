...
impl CreateAgentTokenBuilder {
    ...
    pub fn agent_creator_did(mut self, d: impl Into<String>) -> Self {
        self.agent_creator_did = Some(d.into());
        self
    }
    ...
    pub fn icon_url(mut self, u: impl Into<String>) -> Self {
        self.icon_url = Some(u.into());
        self
    }
    ...
    pub fn mwvm_hooks(mut self, h: Vec<String>) -> Self {
        self.mwvm_hooks = h;
        self
    }
    pub fn initial_k(mut self, k: impl Into<String>) -> Self {
        self.initial_k = Some(k.into());
        self
    }
    pub fn initial_graduation_mcap(mut self, m: impl Into<String>) -> Self {
        self.initial_graduation_mcap = Some(m.into());
        self
    }
    ...
    pub fn build(self) -> Result<CreateAgentTokenRequest, SdkError> {
        let sender = self
            .sender
            .ok_or_else(|| SdkError::invalid_input("sender is required"))?;
        let agent_creator_did = self
            .agent_creator_did
            .ok_or_else(|| SdkError::invalid_input("agent_creator_did is required"))?;
        let name = self
            .name
        ...
        let decimals = self
            .decimals
            .ok_or_else(|| SdkError::invalid_input("decimals is required"))?;

        let mut req =
            CreateAgentTokenRequest::new(sender, agent_creator_did, name, symbol, decimals);
        ...
        if !self.tags.is_empty() {
            req = req.tags(self.tags);
        }
        if !self.mwvm_hooks.is_empty() {
            req = req.mwvm_hooks(self.mwvm_hooks);
        }
        if let Some(v) = self.initial_k {
            req = req.initial_k(v);
        }
        if let Some(v) = self.initial_graduation_mcap {
            req = req.initial_graduation_mcap(v);
        }
        Ok(req)
    }
}
...
impl BuyBuilder {
    ...
    pub fn token_index(mut self, idx: u64) -> Self {
        self.token_index = Some(idx);
        self
    }
    pub fn morm_amount(mut self, a: impl Into<String>) -> Self {
        self.morm_amount = Some(a.into());
        self
    }
    ...
    pub fn build(self) -> Result<BuyRequest, SdkError> {
        let token_index = self
            .token_index
            .ok_or_else(|| SdkError::invalid_input("token_index is required"))?;
        let morm_amount = self
            .morm_amount
            .ok_or_else(|| SdkError::invalid_input("morm_amount is required"))?;
...
impl SellBuilder {
    ...
    pub fn token_amount(mut self, a: impl Into<String>) -> Self {
        self.token_amount = Some(a.into());
        self
    }
    ...
    pub fn build(self) -> Result<SellRequest, SdkError> {
        ...
        let token_amount = self
            .token_amount
            .ok_or_else(|| SdkError::invalid_input("token_amount is required"))?;
...
mod tests {
    ...
    fn create_agent_token_builder_full() {
        let req = CreateAgentTokenBuilder::new()
            .sender("morpheum1abc")
            .agent_creator_did("did:morpheum:agent1")
            .name("TestCoin")
            .symbol("TST")
            .decimals(8)
            .initial_k("1000000")
    ...
    fn buy_builder_works() {
        let req = BuyBuilder::new()
            .token_index(42)
            .morm_amount("100000000")
            .build()
            .unwrap();
    ...
    fn execute_graduation_builder_works() {
        let req = ExecuteGraduationBuilder::new()
            .token_index(42)
            .build()
            .unwrap();
        assert_eq!(req.token_index, 42);
