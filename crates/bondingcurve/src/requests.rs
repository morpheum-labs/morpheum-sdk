...
impl CreateAgentTokenRequest {
    pub fn new(
        ...
        agent_creator_did: impl Into<String>,
        ...
        Self {
            sender: sender.into(),
            agent_creator_did: agent_creator_did.into(),
            name: name.into(),
            symbol: symbol.into(),
            decimals,
            icon_url: None,
    ...
    pub fn to_any(&self) -> ProtoAny {
        ...
        ProtoAny {
            type_url: "/bondingcurve.v1.MsgLaunchToken".into(),
...
impl From<CreateAgentTokenRequest> for proto::MsgLaunchToken {
    fn from(r: CreateAgentTokenRequest) -> Self {
        Self {
            sender: r.sender,
            creator_did: r.agent_creator_did,
            name: r.name,
            symbol: r.symbol,
            decimals: r.decimals,
            ...
            tags: r.tags,
            mwvm_hooks: r.mwvm_hooks,
            prediction_enhancement: None,
            initial_k: r.initial_k,
            initial_graduation_mcap: r.initial_graduation_mcap,
        }
    }
}
...
impl BuyRequest {
    ...
    pub fn to_any(&self) -> ProtoAny {
        ...
        ProtoAny {
            type_url: "/bondingcurve.v1.MsgBuy".into(),
            value: msg.encode_to_vec(),
        }
    }
}
...
impl From<BuyRequest> for proto::MsgBuy {
    fn from(r: BuyRequest) -> Self {
        Self {
            token_index: r.token_index,
            morm_amount: r.morm_amount,
        }
    }
}
...
impl SellRequest {
    ...
    pub fn to_any(&self) -> ProtoAny {
        ...
        ProtoAny {
            type_url: "/bondingcurve.v1.MsgSell".into(),
            value: msg.encode_to_vec(),
        }
    }
}
...
impl ExecuteGraduationRequest {
    ...
    pub fn to_any(&self) -> ProtoAny {
        let msg = proto::MsgExecuteGraduation {
            token_index: self.token_index,
        };
        ProtoAny {
            type_url: "/bondingcurve.v1.MsgExecuteGraduation".into(),
            value: msg.encode_to_vec(),
        }
    }
}
...
impl From<GetCurveStateRequest> for proto::GetCurveStateRequest {
    fn from(r: GetCurveStateRequest) -> Self {
        Self {
            token_index: r.token_index,
        }
    }
...
impl From<GetPriceRequest> for proto::GetPriceRequest {
    fn from(r: GetPriceRequest) -> Self {
        Self {
            token_index: r.token_index,
        }
    }
...
mod tests {
    ...
    fn create_agent_token_to_any() {
        let req = CreateAgentTokenRequest::new(
            "morpheum1abc",
            "did:morpheum:agent1",
            "AgentCoin",
            "AGNT",
