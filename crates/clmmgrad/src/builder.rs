...
use crate::requests::{CancelGraduationRequest, InitiateGraduationRequest};
...
impl InitiateGraduationBuilder {
    ...
    pub fn token_index(mut self, idx: impl Into<String>) -> Self {
        self.token_index = Some(idx.into());
        self
    }
...
mod tests {
    ...
    fn initiate_builder_works() {
        let req = InitiateGraduationBuilder::new()
            .token_index("42")
            .build()
            .unwrap();
    ...
    fn cancel_builder_works() {
        let req = CancelGraduationBuilder::new()
            .token_index("42")
            .build()
            .unwrap();
        assert_eq!(req.token_index, "42");
