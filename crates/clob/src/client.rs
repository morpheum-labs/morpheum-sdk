...
impl ClobClient {
    ...
    pub async fn query_orderbook_snapshot(
        ...
        let resp = self
            .query(
                "/clob.v1.Query/QueryOrderBookSnapshot",
                proto_req.encode_to_vec(),
            )
            .await?;
        let p = proto::QueryOrderbookSnapshotResponse::decode(resp.as_slice())
    ...
    pub async fn query_orders_by_address(
        &self,
        request: requests::QueryOrdersByAddressRequest,
        ...
        let resp = self
            ...
            .await?;
        let p = proto::QueryOrdersByAddressResponse::decode(resp.as_slice())
            .map_err(SdkError::Decode)?;
    ...
    pub async fn query_orders_by_market(
        &self,
        request: requests::QueryOrdersByMarketRequest,
    ) -> Result<Vec<Order>, SdkError> {
        let proto_req: proto::QueryOrdersByMarketRequest = request.into();
        let resp = self
            .query(
                "/clob.v1.Query/QueryOrdersByMarket",
                proto_req.encode_to_vec(),
            )
            .await?;
        let p = proto::QueryOrdersByMarketResponse::decode(resp.as_slice())
            .map_err(SdkError::Decode)?;
        Ok(p.orders.into_iter().map(Into::into).collect())
    }
    ...
    pub async fn query_order_by_id(
        ...
        let resp = self
            .query("/clob.v1.Query/QueryOrderById", proto_req.encode_to_vec())
            .await?;
    ...
    pub async fn query_trades_by_address(
        &self,
        request: requests::QueryTradesByAddressRequest,
    ) -> Result<Vec<Trade>, SdkError> {
        let proto_req: proto::QueryTradesByAddressRequest = request.into();
        let resp = self
            .query(
                "/clob.v1.Query/QueryTradesByAddress",
                proto_req.encode_to_vec(),
            )
            .await?;
        let p = proto::QueryTradesByAddressResponse::decode(resp.as_slice())
            .map_err(SdkError::Decode)?;
    ...
    pub async fn query_trades_by_market(
        &self,
        request: requests::QueryTradesByMarketRequest,
    ) -> Result<Vec<Trade>, SdkError> {
        let proto_req: proto::QueryTradesByMarketRequest = request.into();
        let resp = self
            .query(
                "/clob.v1.Query/QueryTradesByMarket",
                proto_req.encode_to_vec(),
            )
            .await?;
        let p = proto::QueryTradesByMarketResponse::decode(resp.as_slice())
            .map_err(SdkError::Decode)?;
        Ok(p.trades.into_iter().map(Into::into).collect())
    }
    ...
    pub async fn query_funding_rate(&self, market_index: u64) -> Result<FundingRate, SdkError> {
        ...
        let resp = self
            .query("/clob.v1.Query/QueryFundingRate", proto_req.encode_to_vec())
            .await?;
        let p =
            proto::QueryFundingRateResponse::decode(resp.as_slice()).map_err(SdkError::Decode)?;
        if !p.success {
            return Err(SdkError::transport(if p.error_message.is_empty() {
                "funding rate query failed"
            } else {
                &p.error_message
            }));
        }
    ...
    pub async fn query_funding_rates(
        &self,
        request: requests::QueryFundingRatesRequest,
    ) -> Result<Vec<FundingRateEntry>, SdkError> {
        let proto_req: proto::QueryFundingRatesRequest = request.into();
        let resp = self
            .query(
                "/clob.v1.Query/QueryFundingRates",
                proto_req.encode_to_vec(),
            )
            .await?;
        let p =
            proto::QueryFundingRatesResponse::decode(resp.as_slice()).map_err(SdkError::Decode)?;
    ...
    pub async fn get_checksum(
        ...
        let resp = self
            .query("/clob.v1.Query/GetChecksum", proto_req.encode_to_vec())
            .await?;
    ...
    pub async fn query_active_mm_quotes(
        &self,
        request: requests::QueryActiveMarketMakerQuotesRequest,
    ) -> Result<Vec<MarketMakerQuote>, SdkError> {
        let proto_req: proto::QueryActiveMarketMakerQuotesRequest = request.into();
        let resp = self
            .query(
                "/clob.v1.Query/QueryActiveMarketMakerQuotes",
                proto_req.encode_to_vec(),
            )
            .await?;
        let p = proto::QueryActiveMarketMakerQuotesResponse::decode(resp.as_slice())
            .map_err(SdkError::Decode)?;
    ...
    pub async fn query_mm_quote_by_id(
        ...
        let resp = self
            .query(
                "/clob.v1.Query/QueryMarketMakerQuoteById",
                proto_req.encode_to_vec(),
            )
            .await?;
        let p = proto::QueryMarketMakerQuoteByIdResponse::decode(resp.as_slice())
            .map_err(SdkError::Decode)?;
    ...
    pub async fn query_market_fee_stats(
        ...
        let resp = self
            .query(
                "/clob.v1.Query/QueryMarketFeeStats",
                proto_req.encode_to_vec(),
            )
            .await?;
        let p = proto::QueryMarketFeeStatsResponse::decode(resp.as_slice())
            .map_err(SdkError::Decode)?;
        Ok(p.into())
    }
}
...
mod tests {
    ...
    impl Transport for DummyTransport {
        ...
        async fn query(&self, path: &str, _: Vec<u8>) -> Result<Vec<u8>, SdkError> {
            match path {
                "/clob.v1.Query/QueryOrdersByAddress" => Ok(prost::Message::encode_to_vec(
                    &proto::QueryOrdersByAddressResponse {
                        orders: vec![],
                        total_count: 0,
                        timestamp: None,
                ...
                "/clob.v1.Query/QueryOrderById" => Ok(prost::Message::encode_to_vec(
                    &proto::QueryOrderByIdResponse { order: None },
                )),
                "/clob.v1.Query/QueryFundingRate" => Ok(prost::Message::encode_to_vec(
                    &proto::QueryFundingRateResponse {
                        success: true,
                        market_index: 42,
                        ..Default::default()
                    },
    ...
    async fn query_orders_by_address_works() {
        ...
        let result = client
            .query_orders_by_address(requests::QueryOrdersByAddressRequest::new("morpheum1abc"))
            .await;
        assert!(result.is_ok());
