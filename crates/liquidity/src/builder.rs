...
impl CreatePoolBuilder {
    ...
    pub fn initial_liquidity(mut self, v: impl Into<String>) -> Self {
        self.initial_liquidity = Some(v.into());
        self
    }
    pub fn provider_type(mut self, v: u32) -> Self {
        self.provider_type = Some(v);
        self
    }
    pub fn provider_config(mut self, v: Vec<u8>) -> Self {
        self.provider_config = v;
        self
    }
...
impl UpdatePoolParamsBuilder {
    ...
    pub fn pool_id(mut self, v: impl Into<String>) -> Self {
