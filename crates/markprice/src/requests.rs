...
impl UpdateMarkConfigRequest {
    pub fn new(authority: impl Into<String>, market_index: u64, config: MarkConfig) -> Self {
        Self {
    ...
    pub fn to_any(&self) -> ProtoAny {
        ...
        ProtoAny {
            type_url: "/markprice.v1.MsgUpdateMarketConfig".into(),
...
impl From<GetMarkPriceRequest> for proto::GetMarkPriceRequest {
    fn from(r: GetMarkPriceRequest) -> Self {
        Self {
...
impl From<GetMarkPriceWithSourceRequest> for proto::GetMarkPriceWithSourceRequest {
    fn from(r: GetMarkPriceWithSourceRequest) -> Self {
        Self {
            market_index: r.market_index,
        }
    }
