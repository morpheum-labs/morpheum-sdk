...
use crate::requests::{
    BuySharesRequest, ClaimPayoutRequest, CreateAccountRequest, MergePositionsRequest,
    SellSharesRequest,
};
...
impl CreateAccountBuilder {
    ...
    pub fn outcome_id(mut self, v: impl Into<String>) -> Self {
        self.outcome_id = Some(v.into());
        self
    }
    pub fn collateral_asset_index(mut self, v: u64) -> Self {
        self.collateral_asset_index = Some(v);
        self
    }
    pub fn initial_collateral(mut self, v: u64) -> Self {
        self.initial_collateral = Some(v);
        self
    }
    ...
    pub fn build(self) -> Result<CreateAccountRequest, SdkError> {
        Ok(CreateAccountRequest::new(
            ...
            self.outcome_id
                .ok_or_else(|| SdkError::invalid_input("outcome_id is required"))?,
            self.collateral_asset_index
                .ok_or_else(|| SdkError::invalid_input("collateral_asset_index is required"))?,
            self.initial_collateral
                .ok_or_else(|| SdkError::invalid_input("initial_collateral is required"))?,
        ))
    }
}
...
impl BuySharesBuilder {
    ...
    pub fn buyer(mut self, v: impl Into<String>) -> Self {
        self.buyer = Some(v.into());
        self
    }
    ...
    pub fn collateral_amount(mut self, v: u64) -> Self {
        self.collateral_amount = Some(v);
        self
    }
    pub fn min_shares_received(mut self, v: u64) -> Self {
        self.min_shares_received = v;
        self
    }
    pub fn max_fee_bps(mut self, v: u32) -> Self {
        self.max_fee_bps = v;
        self
    }
    ...
    pub fn build(self) -> Result<BuySharesRequest, SdkError> {
        Ok(BuySharesRequest::new(
            self.buyer
                .ok_or_else(|| SdkError::invalid_input("buyer is required"))?,
            self.account_id
                .ok_or_else(|| SdkError::invalid_input("account_id is required"))?,
            self.collateral_amount
                .ok_or_else(|| SdkError::invalid_input("collateral_amount is required"))?,
            self.min_shares_received,
            self.max_fee_bps,
        ))
    }
}
...
impl SellSharesBuilder {
    ...
    pub fn seller(mut self, v: impl Into<String>) -> Self {
        self.seller = Some(v.into());
        self
    }
    pub fn account_id(mut self, v: impl Into<String>) -> Self {
        self.account_id = Some(v.into());
    ...
    pub fn shares_amount(mut self, v: u64) -> Self {
        self.shares_amount = Some(v);
        self
    }
    pub fn min_collateral_received(mut self, v: u64) -> Self {
        self.min_collateral_received = v;
        self
    }
    ...
    pub fn build(self) -> Result<SellSharesRequest, SdkError> {
        Ok(SellSharesRequest::new(
            self.seller
                .ok_or_else(|| SdkError::invalid_input("seller is required"))?,
            self.account_id
                .ok_or_else(|| SdkError::invalid_input("account_id is required"))?,
            self.shares_amount
                .ok_or_else(|| SdkError::invalid_input("shares_amount is required"))?,
...
impl MergePositionsBuilder {
    ...
    pub fn merger(mut self, v: impl Into<String>) -> Self {
        self.merger = Some(v.into());
        self
    }
    pub fn account_ids(mut self, v: Vec<String>) -> Self {
        self.account_ids = v;
        self
    }
    pub fn min_collateral_received(mut self, v: u64) -> Self {
    ...
    pub fn build(self) -> Result<MergePositionsRequest, SdkError> {
        if self.account_ids.len() < 2 {
            return Err(SdkError::invalid_input(
                "at least 2 account_ids required for merge",
            ));
        }
        Ok(MergePositionsRequest::new(
            self.merger
                .ok_or_else(|| SdkError::invalid_input("merger is required"))?,
            self.account_ids,
            self.min_collateral_received,
        ))
    }
...
impl ClaimPayoutBuilder {
    ...
    pub fn claimer(mut self, v: impl Into<String>) -> Self {
        self.claimer = Some(v.into());
        self
    }
    ...
    pub fn build(self) -> Result<ClaimPayoutRequest, SdkError> {
        Ok(ClaimPayoutRequest::new(
            self.claimer
                .ok_or_else(|| SdkError::invalid_input("claimer is required"))?,
            self.beneficiary
