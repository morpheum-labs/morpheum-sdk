...
impl CreateMarketBuilder {
    ...
    pub fn criteria_json(mut self, v: impl Into<String>) -> Self {
        self.criteria_json = Some(v.into());
        self
    }
    pub fn min_morm_stake(mut self, v: impl Into<String>) -> Self {
        self.min_morm_stake = Some(v.into());
        self
    }
    pub fn creator_bucket_id(mut self, v: u64) -> Self {
        self.creator_bucket_id = Some(v);
        self
    }
    pub fn quote_asset_index(mut self, v: u64) -> Self {
        self.quote_asset_index = v;
        self
    }
    ...
    pub fn build(self) -> Result<CreateMarketRequest, SdkError> {
        ...
        Ok(CreateMarketRequest::new(
            self.creator
                .ok_or_else(|| SdkError::invalid_input("creator is required"))?,
            self.feed_id
                .ok_or_else(|| SdkError::invalid_input("feed_id is required"))?,
            self.outcomes,
            self.criteria_json
                .ok_or_else(|| SdkError::invalid_input("criteria_json is required"))?,
            self.min_morm_stake
                .ok_or_else(|| SdkError::invalid_input("min_morm_stake is required"))?,
            self.creator_bucket_id
                .ok_or_else(|| SdkError::invalid_input("creator_bucket_id is required"))?,
...
impl ResolveMarketBuilder {
    ...
    pub fn signer(mut self, v: impl Into<String>) -> Self {
        self.signer = Some(v.into());
        self
    }
    pub fn feed_id(mut self, v: impl Into<String>) -> Self {
        self.feed_id = Some(v.into());
    ...
    pub fn winning_outcome_id(mut self, v: u32) -> Self {
        self.winning_outcome_id = Some(v);
        self
    }
    /// Fixed-point confidence: 0..1_000_000_000 (1e9 scale).
    pub fn confidence(mut self, v: u32) -> Self {
    ...
    pub fn build(self) -> Result<ResolveMarketRequest, SdkError> {
        let outcome = ResolvedOutcome {
            feed_id: self
                .feed_id
                .ok_or_else(|| SdkError::invalid_input("feed_id is required"))?,
            winning_outcome_id: self
                .winning_outcome_id
                .ok_or_else(|| SdkError::invalid_input("winning_outcome_id is required"))?,
            confidence: self
                .confidence
                .ok_or_else(|| SdkError::invalid_input("confidence is required"))?,
        };
        Ok(ResolveMarketRequest::new(
            self.signer
                .ok_or_else(|| SdkError::invalid_input("signer is required"))?,
            outcome,
        ))
    }
}
...
impl DisputeMarketBuilder {
    ...
    pub fn challenger(mut self, v: impl Into<String>) -> Self {
        self.challenger = Some(v.into());
        self
    }
    pub fn feed_id(mut self, v: impl Into<String>) -> Self {
        self.feed_id = Some(v.into());
    ...
    pub fn bond_amount(mut self, v: impl Into<String>) -> Self {
        self.bond_amount = Some(v.into());
        self
    }
    pub fn evidence_data(mut self, v: Vec<u8>) -> Self {
        self.evidence_data = v;
        self
    }
    pub fn reason_code(mut self, v: u32) -> Self {
        self.reason_code = v;
        self
    }
    pub fn challenger_bucket_id(mut self, v: u64) -> Self {
        self.challenger_bucket_id = Some(v);
        self
    }
    ...
    pub fn build(self) -> Result<DisputeMarketRequest, SdkError> {
        Ok(DisputeMarketRequest::new(
            self.challenger
                .ok_or_else(|| SdkError::invalid_input("challenger is required"))?,
            self.feed_id
                .ok_or_else(|| SdkError::invalid_input("feed_id is required"))?,
            self.bond_amount
                .ok_or_else(|| SdkError::invalid_input("bond_amount is required"))?,
            self.evidence_data,
            self.reason_code,
            self.challenger_bucket_id
                .ok_or_else(|| SdkError::invalid_input("challenger_bucket_id is required"))?,
        ))
    }
}
...
impl LightChallengeVoteBuilder {
    ...
    pub fn voter(mut self, v: impl Into<String>) -> Self {
        self.voter = Some(v.into());
        self
    }
    pub fn feed_id(mut self, v: impl Into<String>) -> Self {
        self.feed_id = Some(v.into());
    ...
    pub fn agree(mut self, v: bool) -> Self {
        self.agree = v;
        self
    }
    pub fn weight(mut self, v: u64) -> Self {
        self.weight = v;
        self
    }
    ...
    pub fn build(self) -> Result<LightChallengeVoteRequest, SdkError> {
        Ok(LightChallengeVoteRequest::new(
            self.voter
                .ok_or_else(|| SdkError::invalid_input("voter is required"))?,
            self.feed_id
                .ok_or_else(|| SdkError::invalid_input("feed_id is required"))?,
            self.agree,
            self.weight,
