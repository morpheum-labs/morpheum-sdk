...
impl CreateMarketRequest {
    pub fn new(
        ...
        outcomes: Vec<String>,
        criteria_json: impl Into<String>,
        min_morm_stake: impl Into<String>,
        creator_bucket_id: u64,
        ...
        Self {
            ...
            outcomes,
            criteria_json: criteria_json.into(),
            min_morm_stake: min_morm_stake.into(),
            creator_bucket_id,
            quote_asset_index,
        }
    }
    ...
    pub fn to_any(&self) -> ProtoAny {
        let msg = proto::MsgCreateMarket {
            ...
            criteria_json: self.criteria_json.clone(),
            min_morm_stake: self.min_morm_stake.clone(),
            creator_bucket_id: self.creator_bucket_id,
            quote_asset_index: self.quote_asset_index,
        };
        ProtoAny {
            type_url: "/prediction.v1.MsgCreateMarket".into(),
...
impl ResolveMarketRequest {
    ...
    pub fn to_any(&self) -> ProtoAny {
        ...
        ProtoAny {
            type_url: "/prediction.v1.MsgResolveMarket".into(),
            value: msg.encode_to_vec(),
        }
    }
}
...
impl DisputeMarketRequest {
    pub fn new(
        ...
        feed_id: impl Into<String>,
        bond_amount: impl Into<String>,
        evidence_data: Vec<u8>,
        reason_code: u32,
        challenger_bucket_id: u64,
    ) -> Self {
        Self {
    ...
    pub fn to_any(&self) -> ProtoAny {
        let msg = proto::MsgDisputeMarket {
            ...
            feed_id: self.feed_id.clone(),
            bond_amount: self.bond_amount.clone(),
            evidence_data: self.evidence_data.clone(),
            reason_code: self.reason_code,
            challenger_bucket_id: self.challenger_bucket_id,
        };
        ProtoAny {
            type_url: "/prediction.v1.MsgDisputeMarket".into(),
            value: msg.encode_to_vec(),
        }
    }
}
...
impl OpenLightChallengeRequest {
    ...
    pub fn to_any(&self) -> ProtoAny {
        ...
        ProtoAny {
            type_url: "/prediction.v1.MsgOpenLightChallenge".into(),
            value: msg.encode_to_vec(),
        }
    }
}
...
impl LightChallengeVoteRequest {
    ...
    pub fn to_any(&self) -> ProtoAny {
        ...
        ProtoAny {
            type_url: "/prediction.v1.MsgLightChallengeVote".into(),
            value: msg.encode_to_vec(),
        }
    }
}
...
mod tests {
    ...
    fn dispute_market_to_any() {
        let any = DisputeMarketRequest::new("morph1ch", "f1", "50000", Vec::new(), 1, 2).to_any();
