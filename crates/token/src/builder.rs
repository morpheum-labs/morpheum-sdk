...
use crate::requests::{
    CreateTokenRequest, DisableHookRequest, SetOriginMetadataRequest, SetTradableRequest,
...
impl CreateTokenBuilder {
    ...
    pub fn agent_creator_did(mut self, v: impl Into<String>) -> Self {
        self.agent_creator_did = Some(v.into());
        self
    }
    pub fn programmable(mut self, v: ProgrammableLogicConfig) -> Self {
        self.programmable = Some(v);
        self
    }
    pub fn tradable(mut self, v: bool) -> Self {
        self.tradable = v;
        self
    }
    pub fn origin(
...
impl DisableHookBuilder {
    ...
    pub fn hook_point(mut self, v: HookPoint) -> Self {
        self.hook_point = v;
        self
    }
    pub fn signer_address(mut self, v: impl Into<String>) -> Self {
...
impl SetOriginMetadataBuilder {
    ...
    pub fn origin_chain(mut self, v: impl Into<String>) -> Self {
        self.origin_chain = Some(v.into());
        self
    }
    pub fn origin_address(mut self, v: impl Into<String>) -> Self {
        self.origin_address = Some(v.into());
        self
    }
    pub fn bridge_protocol(mut self, v: impl Into<String>) -> Self {
        self.bridge_protocol = Some(v.into());
        self
    }
    pub fn is_wrapped(mut self, v: bool) -> Self {
        self.is_wrapped = v;
        self
    }
    pub fn signer_address(mut self, v: impl Into<String>) -> Self {
    ...
    pub fn build(self) -> Result<SetOriginMetadataRequest, SdkError> {
        Ok(SetOriginMetadataRequest::new(
            self.asset_index
                .ok_or_else(|| SdkError::invalid_input("asset_index is required"))?,
            self.origin_chain
                .ok_or_else(|| SdkError::invalid_input("origin_chain is required"))?,
            self.origin_address
                .ok_or_else(|| SdkError::invalid_input("origin_address is required"))?,
