...
impl SweepRevenueBuilder {
    ...
    pub fn source_module(mut self, v: impl Into<String>) -> Self {
        self.source_module = Some(v.into());
        self
    }
    pub fn target_category(mut self, v: ReserveCategory) -> Self {
        self.target_category = v;
        self
    }
    ...
    pub fn tx_hash(mut self, v: Vec<u8>) -> Self {
        self.tx_hash = v;
        self
    }
    ...
    pub fn build(self) -> Result<SweepRevenueRequest, SdkError> {
        ...
        let mut req = SweepRevenueRequest::new(
            self.source_module
                .ok_or_else(|| SdkError::invalid_input("source_module is required"))?,
...
impl AllocateFundsBuilder {
    ...
    pub fn target_module(mut self, v: impl Into<String>) -> Self {
        self.target_module = v.into();
        self
    }
    pub fn target_category(mut self, v: ReserveCategory) -> Self {
        self.target_category = v;
    ...
    pub fn signature(mut self, v: Vec<u8>) -> Self {
        self.signature = v;
        self
    }
...
impl UpdateParamsBuilder {
    ...
    pub fn params(mut self, v: TreasuryParams) -> Self {
        self.params = Some(v);
        self
    }
...
mod tests {
    ...
    fn sweep_revenue_builder_works() {
        let req = SweepRevenueBuilder::new()
            .source_module("clob")
            .target_category(ReserveCategory::InsuranceProtection)
            .amount(1000)
            .reason("maker_taker_fees")
            .authority("morph1mod")
            .build()
            .unwrap();
