...
impl TreasuryClient {
    ...
    pub async fn get_reserves_state(&self) -> Result<ReservesState, SdkError> {
        let proto_req: proto::QueryReservesStateRequest =
            requests::QueryReservesStateRequest.into();
        let resp = self
            .query(
            ...
            .await?;
        let p =
            proto::QueryReservesStateResponse::decode(resp.as_slice()).map_err(SdkError::Decode)?;
        p.state
            .map(Into::into)
    ...
    pub async fn get_metrics(&self) -> Result<TreasuryMetrics, SdkError> {
        let proto_req: proto::QueryTreasuryMetricsRequest =
            requests::QueryTreasuryMetricsRequest.into();
        let resp = self
            .query(
            ...
            .await?;
        let p = proto::QueryTreasuryMetricsResponse::decode(resp.as_slice())
    ...
    pub async fn get_category_reserve(
        &self,
        req: requests::QueryCategoryReserveRequest,
    ) -> Result<CategoryReserveResult, SdkError> {
        ...
        let resp = self
            ...
            .await?;
        let p = proto::QueryCategoryReserveResponse::decode(resp.as_slice())
            .map_err(SdkError::Decode)?;
    ...
    pub async fn get_params(&self) -> Result<TreasuryParams, SdkError> {
        ...
        let resp = self
            .query("/treasury.v1.Query/QueryParams", proto_req.encode_to_vec())
            .await?;
    ...
    pub async fn get_allocation_history(
        &self,
        req: requests::QueryAllocationHistoryRequest,
    ) -> Result<AllocationHistoryPage, SdkError> {
        ...
        let resp = self
            ...
            .await?;
        let p = proto::QueryAllocationHistoryResponse::decode(resp.as_slice())
            .map_err(SdkError::Decode)?;
...
mod tests {
    ...
    impl Transport for DummyTransport {
        ...
        async fn query(&self, path: &str, _: Vec<u8>) -> Result<Vec<u8>, SdkError> {
            match path {
                "/treasury.v1.Query/QueryReservesState" => Ok(prost::Message::encode_to_vec(
                    &proto::QueryReservesStateResponse {
                        state: Some(proto::ReservesState {
                            categories: vec![],
                            merkle_root: vec![],
                            last_sweep_timestamp: 100,
                ...
                "/treasury.v1.Query/QueryCategoryReserve" => Ok(prost::Message::encode_to_vec(
                    &proto::QueryCategoryReserveResponse {
                ...
                "/treasury.v1.Query/QueryAllocationHistory" => Ok(prost::Message::encode_to_vec(
                    &proto::QueryAllocationHistoryResponse {
                        records: vec![],
                        pagination: None,
                        total_count: 0,
                    },
