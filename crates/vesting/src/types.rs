...
impl From<ScheduleType> for i32 {
    fn from(s: ScheduleType) -> Self {
        match s {
            ScheduleType::Unspecified => 0,
            ScheduleType::Linear => 1,
            ScheduleType::CliffLinear => 2,
            ScheduleType::Step => 3,
        }
    }
}
...
impl From<i32> for VestingCategory {
    fn from(v: i32) -> Self {
        match v {
            1 => Self::Team,
            2 => Self::CoreContributors,
            3 => Self::Investors,
            4 => Self::Advisors,
            5 => Self::CommunityRewards,
            6 => Self::Foundation,
            7 => Self::Ecosystem,
            8 => Self::Treasury,
            9 => Self::Airdrop,
...
impl From<VestingCategory> for i32 {
    fn from(c: VestingCategory) -> Self {
        match c {
            VestingCategory::Unspecified => 0,
            VestingCategory::Team => 1,
            VestingCategory::CoreContributors => 2,
            VestingCategory::Investors => 3,
            VestingCategory::Advisors => 4,
            VestingCategory::CommunityRewards => 5,
            VestingCategory::Foundation => 6,
            VestingCategory::Ecosystem => 7,
            VestingCategory::Treasury => 8,
            VestingCategory::Airdrop => 9,
...
mod tests {
    ...
    fn vesting_category_roundtrip() {
        for c in [
            ...
            VestingCategory::CoreContributors,
            VestingCategory::Investors,
            VestingCategory::Advisors,
            VestingCategory::CommunityRewards,
            VestingCategory::Foundation,
            VestingCategory::Ecosystem,
            VestingCategory::Treasury,
            VestingCategory::Airdrop,
            VestingCategory::Partnership,
        ] {
